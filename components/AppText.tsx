 ...
 */
type TextVariant = "body" | "muted" | "brand";
...
type AppTextProps = RNTextProps & TextThemeProps & { className?: ClassNameValue };
...
export const AppText: React.FC<AppTextProps> = ({
  ...
  return (
    <RNText className={mergedClassName} style={[{ color }, style]} {...otherProps}>
      {children}
    </RNText>
  );
};
